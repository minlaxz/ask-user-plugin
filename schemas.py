...
ASK_USER_SCHEMA = {
    ...
    "description": (
        ...
        "IMPORTANT: Calling this tool ENDS YOUR TURN. After you call it, produce "
        "no further text and no further tool calls — the user is not reachable "
        "until they submit the form. Never guess or fabricate the user's answers.\n\n"
